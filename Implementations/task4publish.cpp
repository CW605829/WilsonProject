...
#define TOPIC      "CW605829/feeds/project.indicator"
...
int readGPIOin(){
    GPIO pin46(46);
    pin46.setDirection(INPUT);
    pin46.setEdgeType(RISING);
    GPIO_VALUE value = pin46.getValue();
    if(value==HIGH){
        return 0;
    }
    else{
...
int main(int argc, char* argv[]) {
   ...
   sprintf(str_payload, "%d", readGPIOin());
